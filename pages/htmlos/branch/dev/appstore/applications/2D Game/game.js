...
var colisionPoints = [];
function createColisionPoint(xfrom, xto, yfrom, yto, object, data) {
    window.colisionPoints.push({
        xf: xfrom,
        xt: xto,
        yf: yfrom,
        yt: yto,
        object: object,
        data: data,
        death: object?.texture === textures.death,
        isGreenKey: object?.texture === textures.greenKey,
        isGreenKeyBlock: object?.texture === textures.greenKeyBlock,
        isPlateSmall: object?.texture === textures.plateSmall,
        isPlateLarge: object?.texture === textures.plateLarge,
        isGoal: object?.texture === textures.goal,
        isRedKey: object?.texture === textures.redKey,
        isRedKeyBlock: object?.texture === textures.redKeyBlock
    });
}
function isColiding(x, y, sizex, sizey) {
    for (i = 0; i < colisionPoints.length; i++) {
        var p1 = colisionPoints[i];
        if (p1) {
            var o = p1.object; //This removes the object to prevent cyclic object error.
            p1.object = null;
            var p = JSON.parse(JSON.stringify(colisionPoints[i])); //p = points, the parse and stringify are for making a clone of the object.
            p1.object = o;
            p.xf = p.xf - sizex;
            p.yf = p.yf - sizey;
...
function createColisionObject(x, y, sizex, sizey, color, texture, data) {
    var length = colisionPoints.length;
    var o = r.createObject(x, y, sizex, sizey, color, texture);
    var oldRemove = o.remove;
    o.remove = function() {
        oldRemove();
        colisionPoints[length] = null;
    }
    createColisionPoint(x, x + sizex, y, y + sizey, o, data);
    return o;
}
...
function loadObjects() {
    ...
    createColisionObject(0, 50, 100, 10, "#994400", textures.blockTop);
    createColisionObject(0, 60, 100, 40, "#994400", textures.block);

    createColisionObject(125, 40, 10, 10, "#994400", textures.blockTop);
    createColisionObject(135, 50, 15, 10, "#ff0000", textures.death);
    createColisionObject(150, 30, 30, 10, "#994400", textures.blockTop);
    createColisionObject(170, 90, 20, 10, "#994400", textures.blockTop);
    createColisionObject(172, 88, 16, 02, "#22dd22", textures.plateSmall, {size: 4});
    ...
    createColisionObject(160, 65, 10, 10, "#00ff00", textures.greenKey);
    createColisionObject(230, 65, 10, 10, "#00ff00", textures.greenKeyBlock);
    createColisionObject(210, 75, 120, 10, "#994400", textures.blockTop);
    createColisionObject(210, 85, 120, 15, "#994400", textures.block);
    createColisionObject(210, 00, 40, 10, "#994400", textures.blockTop);
    createColisionObject(210, 10, 20, 45, "#994400", textures.block);
    createColisionObject(220, 55, 10, 10, "#994400", textures.block);
    createColisionObject(230, 10, 20, 35, "#994400", textures.block);
    createColisionObject(240, 45, 10, 20, "#994400", textures.block);
    createColisionObject(230, 55, 10, 10, "#ff0000", textures.redKeyBlock);
    createColisionObject(230, 45, 10, 10, "#44bb44", textures.goal, {
        playerx: 360,
        playery: 64,
        scrollx: 350,
    ...
    createColisionObject(262, 73, 06, 02, "#dd2222", textures.plateLarge, {size: 40});
    createColisionObject(252, 20, 10, 10, "#ff0000", textures.redKey);

    createColisionObject(320, 0, 10, 75, "#44bb44", textures.goal, {
        playerx: 10,
        playery: 39,
        scrollx: 0,
    ...
    //Level 2
    createColisionObject(350, 75, 200, 10, "#994400", textures.blockTop);
    createColisionObject(350, 85, 200, 35, "#994400", textures.block);
    
    //Left Border
    if (leftborder) {
        createColisionPoint(0, 0, 0, 100);
        createColisionPoint(350, 350, 0, 100);
    }
}
loadObjects();
